...
namespace App\DI\Bridge\Slim;

/** 
 * App\DI\Bridge\Slim\Bridge::class
 * 
 * Needed to support Psr\Container v2 due to php-di/slim-bridge not being updated at the moment.
 */
